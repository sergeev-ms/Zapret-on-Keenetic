...
(обязательно) Установить entware на маршрутизатор по инструкции [(рекомендуется) на USB-накопитель](https://help.keenetic.com/hc/ru/articles/360021214160) или [(настоятельно не рекомендуется) на встроенную память роутера](https://help.keenetic.com/hc/ru/articles/360021888880).
