...
Далее выбираем "wan interface:" (Например на keenetic giga kn-1011 с провайдером Ростелеком это 18:ppp0, то есть если при настройки использовались учетные данные pppoe логин и пароль, в ином случае 11:eth2.4)
```
18
```
