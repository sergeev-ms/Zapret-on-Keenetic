...
(обязательно) Установить entware на маршрутизатор по инструкции [(не рекомендуется) на встроенную память роутера](https://help.keenetic.com/hc/ru/articles/360021888880) или [(рекомендуется) на USB-накопитель](https://help.keenetic.com/hc/ru/articles/360021214160).

(обязательно) Через web-интерфейс Keenetic установить пакеты **Протокол IPv6** и **Модули ядра подсистемы Netfilter**.

(опционально) Можно [настроить использование DoT/DoH](https://help.keenetic.com/hc/ru/articles/360007687159).
