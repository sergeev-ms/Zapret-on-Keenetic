...
### P.S. Это не VPN и не прокси, это минисофт для обмана (подмены) пакетов tcp и udp протокола, не режет скорость, повышается анонимность, а также не ломает то, что и так хорошо работало.

## Подготовка

(рекомендуется) Keenetic Viva kn-1912 с 256мб ОЗУ и дороже.

(не рекомендуется) Keenetic Extra, Viva с менее 256мб ОЗУ, увы софт кушает хорошо ОЗУ, могут быть зависания.
